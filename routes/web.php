...
Route::prefix('blog')->group(function() {
   ...
   Route::get('/posts/find', 'PostController@formFind')->name('blog.post.find')->middleware('auth');
   Route::post('/posts/find', 'PostController@find')->name('post.find')->middleware('auth');
